...
export function TeamTable({ data, isLoading, onEdit, onDelete }: TeamTableProps) {
        ...
        return imageUrl ? (
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>Lihat gambar tim</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        ) : (
        ...
        <div className="flex items-center justify-center gap-2">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>Edit tim ini</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>Hapus tim ini</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
      ),
    ...
    return (
      <div className="rounded-md border p-12 w-full flex items-center justify-center bg-background/50">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground">Sedang memuat data tim...</p>
        </div>
      </div>
    );
  }
                ...
                <TableCell colSpan={columns.length} className="h-40 text-center">
                  <div className="flex flex-col items-center justify-center gap-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Silakan tambahkan data baru melalui tombol "Tambah Tim".
                    </p>
                  </div>
                </TableCell>
              </TableRow>
