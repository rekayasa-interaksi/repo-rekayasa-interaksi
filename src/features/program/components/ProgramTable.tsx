...
export function ProgramTable({ data, isLoading, onEdit, onDelete }: ProgramTableProps) {
    ...
    columnHelper.accessor('name', {
      ...
      cell: (info) => {
        ...
        return major && major.trim() ? (
          ...
          <span className="text-muted-foreground italic">(Program belum diberi nama)</span>
        );
      },
    }),
